...
//_________________________________________lect30_________________________________filter,map,reduceeee_____________
// const coding = ["js", "ruby", "java", "python", "cpp"]


//in this case we dont return items in case of foreach  loop
...
// const newNums = myNums.filter( (num) => {      //if we open this scope then have to use return keyword but if dont use scope
//then dont need to return directly use num>4
//     return num > 4
// } )


//here we stor all old array valuesin new newNaums array using foreach loop with >4
// const newNums = []
...
//____________________________________REduce______________________________________________
//const myNums = [1, 2, 3]
